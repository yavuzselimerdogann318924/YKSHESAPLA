globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/yks-engine-DBhzW47V.js","assets/page-eviOa3vA.js","assets/page-C151hnvU.js","assets/layout-segment-context-R8Dr8g8T.js"];
...
function getDraftSecret() {
	return "8cb3996c-40a9-4894-b3b9-335d6b6ea68f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "af76db11-23fa-47ce-afa9-771798d0c771";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "af76db11-23fa-47ce-afa9-771798d0c771") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "af76db11-23fa-47ce-afa9-771798d0c771",
		rootBoundaryId
	});
}
/**
...
var metadata = {
	...
	description: "2026 TYT, AYT ve YDT puan-sıralama hesaplama; 21.493 ön lisans ve lisans programında üniversite, bölüm, taban puan ve tahmini sıra arama aracı.",
...
var routes = [{
	...
	ids: {
		"route": "route:/programlar",
		"page": "page:/programlar",
		"routeHandler": null,
		"rootBoundary": "root-boundary:/",
		"layouts": ["layout:/"],
		"templates": [],
